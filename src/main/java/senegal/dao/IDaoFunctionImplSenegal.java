...
public class IDaoFunctionImplSenegal implements IDaoFunction<EmployerSenegal, InfoProfessionelSenegal, InfoPaieSenegal, SalaireSenegal>{
    ...
    public static List<EmployerSenegal> EMPLOYERS = null;
    public static List<InfoProfessionelSenegal> INFO_PROFFS = null;
    public static List<InfoPaieSenegal> INFO_PAIES = null;
    ...
    public List<InfoPaieSenegal> getInfoPaies() throws SQLException, ClassNotFoundException {
        List<InfoPaieSenegal> infoPaies = new ArrayList<>();
        preparedStatement = DbConnexion.getPreparedStatement("SELECT * FROM InfoPaieSenegal");
        resultSet = preparedStatement.executeQuery();
        while (resultSet.next()){
