...
public class IDaoFunctionImplFrance implements IDaoFunction<EmployerFrance, InfoProfessionelFrance, InfoPaieFrance, SalaireFrance> {
    ...
    public static List<EmployerFrance> EMPLOYERS = null;
    public static List<InfoProfessionelFrance> INFO_PROFFS = null;
    public static List<InfoPaieFrance> INFO_PAIES = null;
