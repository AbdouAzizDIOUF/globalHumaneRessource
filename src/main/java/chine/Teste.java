...
public class Teste {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException, IOException {
        IDaoFunctionImplChine dao = new IDaoFunctionImplChine();
        //dao.getSalairesByMounth("01/01/2021-31/01/2021").forEach(e-> System.out.println(e.toString()));
        System.out.println(dao.maxSalaireEmployeByMounth("01/01/2021-31/01/2021").toString());
    }
